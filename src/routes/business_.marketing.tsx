...
export const Route = createFileRoute("/business_/marketing")({
  ...
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Promote your company brand to the Provn student & early-career community.",
      },
    ...
    <BusinessShell>
      <header className="mb-8">
        ...
        <p className="mt-1 max-w-2xl text-sm text-muted-foreground">
          Get in front of thousands of verified builders. Company pages, sponsored posts, and event
          pushes — coming soon.
        </p>
      </header>
      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
        {[
          ...
          {
            t: "Sponsored feed posts",
            d: "Native posts targeted to candidates by verified skill.",
          },
